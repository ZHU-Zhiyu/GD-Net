...
class Hyper_dataset(Dataset):
    ...
    def __init__(self, output_shape=512,ratio = 1,Training_mode='Train',data_name = 'CAVE',use_generated_data = False, use_all_data = True):
        ...
        if data_name == 'CAVE':
            ...
            self.test_name = name['test'] + name['train']
            self.num_pre_img = 4
            ...
            temp = '/home/zhu_19/harvard_name/name.npy'
            name = temp_load(temp)
            name = name.item()
            # print(name)
            self.train_name = name['train']
    ...
    def __getitem__(self, index):
        if self.data_name == 'CAVE':
            ...
            if self.TM=='Train':
                ...
                hsi_g = file[self.test_name[index]][:]/self.max_v
        ...
        return ((hsi_g,hsi_g,hsi_g), hsi_g, hsi_resize, (msi,msi,msi))
