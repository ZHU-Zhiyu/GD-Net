...
class Hyper_dataset(Dataset):
    ...
    def __init__(self, output_shape=512,ratio = 1,Training_mode='Train',data_name = 'CAVE',use_generated_data = False, use_all_data = True):
        ...
        if data_name == 'CAVE':
            self.path =  '/home/user_1/hyperspectral/CAVEdata_1931/'
            ...
            # name = scio.loadmat('/home/user_1/hyperspectral/normal/file_name.mat')
            name = scio.loadmat('/home/user_1/hyperspectral/data/new_train_cave_name.mat')
            self.train_name = name['train']
            # a = name['test']
            # for i in name['train']:
            #     a.append(i)
            # self.test_name = np.concatenate([name['test'],name['train']],0)
            ...
            # self.file = 
            # self.
        self.reps = scio.loadmat('/home/user_1/hyperspectral/normal/resp.mat')['resp']
